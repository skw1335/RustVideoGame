...
use specs::prelude::*;
use super::{CombatStats, Player, gamelog::GameLog, Map, Name, Viewshed, Position, State, InBackpack, RunState, Equipped};
...
pub fn ranged_target(gs : &mut State, ctx : &mut Rltk, range : i32) -> (ItemMenuResult, Option<Point>) {
    ...
    //Highlight in range target cells
...
pub fn game_over(ctx : &mut Rltk) -> GameOverResult {
    ...
    ctx.print_color_centered(17, RGB::named(rltk::WHITE), RGB::named(rltk::BLACK), "One day, we'll tell you all about how you did it.");
